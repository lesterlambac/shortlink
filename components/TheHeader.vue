...
<template>
  <nav class=" border-gray-200 dark:bg-gray-900 bg-gray-100">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      <a href="/" class="inline-flex items-center">
        ...
        <span class="font-bold text-gray-500">Short</span><span class="font-bold text-blue-600">Link</span>
      </a>
      <div class="flex md:order-2">
        <NuxtLink v-if="!user" to="/login" noPrefetch
      ...
      <div :class="[showMenu ? 'flex' : 'hidden']"
        ...
        <ul
          class="md:w-auto w-full flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:border-0  dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
          <li>
            <a href="#"
