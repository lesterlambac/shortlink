  ...
  <div class="px-4 max-w-4xl mx-auto">
    <div>
      ...
      <template v-if="linkList?.data?.length">
        ...
        <div v-for="list in linkList.data" :key="list?.id + updateUI"
          ...
          <div class="flex items-center justify-center">
            ...
            <NuxtLink :to="getOriginalUrl(list.short_link)" target="_blank"
              ...
              <svg class="w-6 h-6 hover:text-blue-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
            ...
            <button @click="handleDelete(list.id)"
